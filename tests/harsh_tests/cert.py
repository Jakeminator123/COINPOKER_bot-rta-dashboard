...
Det här scriptet:
- kör "certutil -store" för Root och CA (user + machine)
- letar efter nyckelord som "mitmproxy", "burp", "fiddler", osv.
- skriver ut alla träffar på ett enkelt sätt
"""
...
def run_certutil(store: str, context_name: str) -> str:
    ...
    if result.returncode != 0:
        # T.ex. vissa stores kan vara tomma i en viss context
        return ""
